...
The mean weight of lizards trapped at the CALI site do not signficantly differ between males and females (p-value = 0.4962, alpha = 0.9)
...
A Chi-Squared test was preformed on the 

There is no significant difference between the ratio of males with broken tails and females with broken tails for the lizards trapped at the CALI site (p-value = 0.6862, x-squared = 0.16319)